    ...
    public partial class categoriaForm : Form
    {
        ...
        private void dgvCategorias_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                // Verificar que el evento se ejecuta correctamente
                MessageBox.Show("Fila seleccionada: " + row.Cells["nombre"].Value.ToString(), "Debug", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
